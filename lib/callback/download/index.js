...
router.post('/callback/download', bodyParser(), async function(ctx) {
  ...
  ctx.res.once('finish', async function () {
    ...
    setTimeout(() => telegram.sendMessage(session,
      'Would you like to have <b>Twitter</b> and <b>Instagram</b> videos inside your Telegram messenger !? 😱😳\n\n' +
      'Follow these channels to download random videos watched by the community:' +
      '\n\n@instavids\n@instavids\n@twittervids\n@twittervids', 'HTML').then(() => null)
    , 3000)
