...
module.exports = function* (user, url) {
  ...
  yield telegram.sendMessage(user, 'Your request has been received.\nIt may take a few seconds to a minute for processing your request\n\n' +
    ...
    'Send your feedbacks to our official Facebook or Twitter pages\n‌‌', 'Markdown', true)
  ...
  try {
    ...
    if (e.response != null && e.response.statusCode == 406)
      return yield telegram.sendMessage(user, e.response.text)
  ...
  yield telegram.sendMessage(user, result, 'HTML', false, { inline_keyboard: formats })
