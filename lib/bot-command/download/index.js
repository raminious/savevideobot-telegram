...
module.exports = async function (session, hash) {
  ...
  const message_id = await telegram.sendMessage(session, 'The bot has been started process and downloading your request\n\n' +
    ...
    'Please be patient\n\n' +
    '- - - - - - - - - - - - - - \n\n' +
    'We will shutdown SaveVideoBot servers on 3rd Nov 2018 \n' +
    'Cerraremos este bot el 3 de noviembre de 2018. \n' +
    'این ربات در تاریخ سوم نوامبر ۲۰۱۸ تعطیل خواهد شد \n' +
    'سنغلق هذا البوت في 3 نوفمبر 2018 \n' +
    'Мы остановим этого бота 3 ноября 2018 года \n'
    , 'Markdown', true)
